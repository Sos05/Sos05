...
🛡️ Passionné par la cybersécurité, l'architecture réseau et les infrastructures cloud<br>
👨‍💻 Je développe des projets pour apprendre et par passion<br>
👨‍🎓 Apprenti Ingénieur Informatique Télécommunications et Réseaux à l'**IMT Nord Europe** (2026-2029)<br>
...
- **[BOBOLE-BOT](https://github.com/Sos05/BOBOLE-BOT)** – Bot utilitaire personnel sur Discord 🛠️<img src="https://img.shields.io/badge/Status-Completed%20Active%20maintenance-green" align="center" alt="Static Badge">

- **[SAÉ Évolution d'une infrastructure](https://github.com/Sos05/SAE-BUT3)** – Mise en place d'une infrastructure avec routage, services centralisés (DNS, DHCP, NFS, LDAP) et sécurisation par Firewall 🌐<img src="https://img.shields.io/badge/Status-Completed-green" align="center" alt="Static Badge">
